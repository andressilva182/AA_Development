...
#include "AA_Development/TP_ThirdPerson/TP_ThirdPersonGameMode.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTP_ThirdPersonGameMode() {}
// Cross Module References
	AA_DEVELOPMENT_API UClass* Z_Construct_UClass_ATP_ThirdPersonGameMode();
	AA_DEVELOPMENT_API UClass* Z_Construct_UClass_ATP_ThirdPersonGameMode_NoRegister();
...
// End Cross Module References
	...
	template<> AA_DEVELOPMENT_API UClass* StaticClass<ATP_ThirdPersonGameMode>()
	{
		return ATP_ThirdPersonGameMode::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATP_ThirdPersonGameMode);
	ATP_ThirdPersonGameMode::~ATP_ThirdPersonGameMode() {}
	struct Z_CompiledInDeferFile_FID_Users_Andres_PC_Documents_Unreal_Projects_AA_Development_Source_AA_Development_TP_ThirdPerson_TP_ThirdPersonGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Andres_PC_Documents_Unreal_Projects_AA_Development_Source_AA_Development_TP_ThirdPerson_TP_ThirdPersonGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATP_ThirdPersonGameMode, ATP_ThirdPersonGameMode::StaticClass, TEXT("ATP_ThirdPersonGameMode"), &Z_Registration_Info_UClass_ATP_ThirdPersonGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATP_ThirdPersonGameMode), 1108061782U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Andres_PC_Documents_Unreal_Projects_AA_Development_Source_AA_Development_TP_ThirdPerson_TP_ThirdPersonGameMode_h_139859143(TEXT("/Script/AA_Development"),
		Z_CompiledInDeferFile_FID_Users_Andres_PC_Documents_Unreal_Projects_AA_Development_Source_AA_Development_TP_ThirdPerson_TP_ThirdPersonGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Andres_PC_Documents_Unreal_Projects_AA_Development_Source_AA_Development_TP_ThirdPerson_TP_ThirdPersonGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
